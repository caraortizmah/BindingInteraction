...
do
	...
	case $input in
      ...
      echo "  8. UCSF Chimera"
      echo "  9. PROPKA 3.1"
      echo " 10. GAMESS - General Atomic and Molecular Electronic Structure System (optional)"
      echo " 11. python 2.7 or higher"
      echo " 12. Facio - GUI program for fragmenting molecules for FMO method (optional)"
      echo "****Warning****"
      count=0
      while [ $count -eq 0 ]
      do
